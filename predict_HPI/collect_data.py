...
def grab_initial_data():
    ...
    pickle_out = open('Data/NSA_pct_change.pickle', 'wb')
...
def HPI_Benchmark():
    ...
    out = open('Data/benchmark_NSA.pickle', 'wb')
...
def mortgage_30y():
    ...
    df.columns = ['M30']
    pickle_out = open('Data/mortgage_30y.pickle', 'wb')
...
def gdp_data():
    ...
    df = df['GDP']
    pickle_out = open('Data/GDP.pickle', 'wb')
    pickle.dump(df, pickle_out)
    pickle_out.close()
...
def us_unemployment():
    ...
    pickle_out = open('Data/us_unemployment.pickle', 'wb')
    pickle.dump(df, pickle_out)
    pickle_out.close()
...
sp500 = sp500_data()
unemployment = pd.read_pickle('Data/us_unemployment.pickle')
gdp = pd.read_pickle('Data/GDP.pickle')
m30 = pd.read_pickle('Data/mortgage_30y.pickle')
HPI_data = pd.read_pickle('Data/NSA_pct_change.pickle')
HPI_bench = pd.read_pickle('Data/benchmark_NSA.pickle')
